     document.addEventListener("DOMContentLoaded", function () {
            ...
            const table = $("#promotionTable").DataTable({
                ...
                ajax: function (data, callback) {
                    ...
                    fetch(`${API_URL}?page=${page}&size=${size}&sort=${sortCol},${orderDir}&keyword=${keyword}`)
                        .then(res => res.json())
                        .then(json => {
                            callback({
        ...
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="alert"></button>`;
            ...
            form.addEventListener("submit", async function (e) {
                ...
                const res = await fetch(isEdit ? `${API_URL}/${idText}` : API_URL, {
                ...
                if (res.ok) {
                    ...
                    const err = await res.json();  // ⬅️ BẮT BUỘC CÓ
            ...
            function setupDateValidation() {
                ...
                // Khi chọn START → cập nhật min của END
